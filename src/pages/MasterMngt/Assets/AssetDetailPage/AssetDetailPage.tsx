...
import GeneralAssetsInfo from "./GeneralAssetsInfo";
    ...
    return (
        <>
            <div className="text-3xl text-black font-medium flex items-center">
                <Link to={'/master-mgmt/assets'} className="inline-block mx-2 p-2 rounded-xl border duration-500 border-transparent hover:border-black">
